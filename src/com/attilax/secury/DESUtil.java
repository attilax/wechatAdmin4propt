...
import sun.misc.BASE64Encoder;  
    ...
    public class DESUtil {  
        ...
        public static void main(String[] args) throws Exception {  
           ...
           String s_en=DESUtil.encryptByDes(str1);
           // DES 解密字符串  
           String deStr = des.decryptStr(str2);  
           String s_de=DESUtil.decryptByDes(s_en);
        ...
        public static String decryptByDes(String s_en) {
			  DESUtil des = new DESUtil( "lovemole" );  
			  String s_de=des.decryptStr(s_en);
			return s_de;
		}

        public static String encryptByDes(String str1) {
			  DESUtil des = new DESUtil( "lovemole" );  
			  String s_en=des.encryptStr(str1);
			return s_en;
