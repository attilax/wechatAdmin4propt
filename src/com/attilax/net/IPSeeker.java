...
public class IPSeeker {
 ...
 //   private static   String IP_FILE ="";
   private static final String IP_FILE =pathx.classPath()+"/QQWry.dat";
	//   IPSeeker.class.getResource("/QQWry.dat").toString().substring(5);

    {
//    String qqwryPath=	IPSeeker.class.getResource("/QQWry.dat").toString();
//    core.logger.info(" qqwryPath:"+qqwryPath);
//    try{
