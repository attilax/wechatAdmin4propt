...
import com.focusx.entity.weixin.message.response.ArticleMessage;
import com.focusx.entity.weixin.message.response.MusicMessage;
...
/*	                if (cdata) {  
     ...
     * @return xml 
     */  
    public static String newsMessageToXml(ArticleMessage articleMessage) {  
